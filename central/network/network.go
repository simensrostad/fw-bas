...
func Sync(outgoing_message <-chan gatt.Advertisement, incoming_message chan gatt.Advertisement, online_status chan PEER_STATUS_UPDATE, localIP string) {
	...
	//broadcast_message := make(chan gatt.Advertisement)
